...
// File: contracts/DaoFactory/IProposal.sol
...
// File: contracts/DaoFactory/Proposal.sol
...
// File: contracts/DaoFactory/gtDemo.sol
    ...
    AccessControl
{
    ...
    function revokeProposalRole(address proposal) external {
        require(proposal != address(0), "Invalid proposal address");
        _revokeRole(PROPOSAL_ROLE, proposal);
    }
    ...
    function isDAO(address account) external view returns (bool) {
        return daoAddress[account] != address(0);
    }
...
//0x2b87b9b56663fDed2707237987e2d394456bA429

// File: contracts/DaoFactory/IDao.sol
...
// File: contracts/DaoFactory/Dao.sol
...
// File: contracts/DaoFactory/IDaoFactory.sol
...
// File: contracts/DaoFactory/proxyDaoFactory.sol
...
contract DAOFactory is Initializable, UUPSUpgradeable, OwnableUpgradeable, IDAOFactory {
    address daoFactoryCouncilAddress;
    uint32 public daoId;
    bytes32 private constant DAO_COUNCIL = keccak256("DAO_COUNCIL");
    ...
    // Initialize function to replace constructor logic in upgradeable contracts
    function initialize(address daoFactoryCouncil) public initializer {
        __Ownable_init(daoFactoryCouncil);
        __UUPSUpgradeable_init();
        daoFactoryCouncilAddress = daoFactoryCouncil;
        daoId = 0; // Initialize daoId to 0
    }

    // UUPS requires the _authorizeUpgrade function for security
